...
### 왜 그런가
S&P 500이 0.05% 상승하자 시장 전반에 긍정적 흐름이 형성되었습니다.
나스닥 100이 0.18% 상승하는 반면 VIX 지수는 20.6으로 상승했습니다.
이는 시장 전반에 위험자산 선호가 강화된 결과로 보입니다.
...
| 항목 | 가격 | 등락 | 등락률 | 흐름 |
|------|------|------|--------|------|
| 비트코인 (BTC) | 69,601 | +1,879.23 | +2.70% | - ⚡ 상위 10% |
| 이더리움 (ETH) | 2,074.63 | +84.64 | +4.08% | - |
| 공포탐욕지수 | 9 (극단적 공포) | - | - | - |
...
<div class="mp-briefing-meta">
  <span>생성 시각: 2026-02-14 23:52:18 KST</span>
  <span>브리핑 슬롯: pre-market (개장전)</span>
  <span>데이터 기준 시각: 2026-02-14 23:52:18 KST</span>
</div>
