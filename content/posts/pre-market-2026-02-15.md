...
### 왜 그런가
오늘 리스크가 커지는 모습을 보이다가 위험자산 선호가 강화되는 모습이 나타났다.
S&P 500이 0.05% 상승한 가운데, 나스닥 종합은 0.22% 하락했다.
이에 따라 VIX 지수는 20.6으로 상승했다.
하지만 나스닥 100은 0.18% 상승하며 상대 강도를 보였다.
그래서 오늘은: 위험자산 선호가 강화되는 모습을 보이고 있는가?
그리고 종목별 차별화 장세가 나타나고 있는가?
...
<div class="mp-briefing-meta">
  <span>생성 시각: 2026-02-15 00:05:05 KST</span>
  <span>브리핑 슬롯: pre-market (개장전)</span>
  <span>데이터 기준 시각: 2026-02-15 00:05:05 KST</span>
</div>
