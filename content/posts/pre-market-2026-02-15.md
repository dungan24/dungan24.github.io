...
### 왜 그런가
지수 흐름은 엇갈렸습니다.
S&P 500 +0.05%와 나스닥 종합 -0.22%가 같은 방향으로 움직이지 않았습니다.
반면 VIX 20.6는 리스크 프리미엄이 아직 내려오지 않았음을 보여줍니다.
...
| 항목 | 가격 | 등락 | 등락률 | 흐름 |
|------|------|------|--------|------|
| 비트코인 (BTC) | 69,719 | +1,491.99 | +2.14% | ↑3일 |
| 이더리움 (ETH) | 2,086.88 | +71.37 | +3.42% | - |
| 공포탐욕지수 | 9 (극단적 공포) | - | - | - |
...
<div class="mp-briefing-meta">
  <span>생성 시각: 2026-02-15 00:20:35 KST</span>
  <span>브리핑 슬롯: pre-market (개장전)</span>
  <span>데이터 기준 시각: 2026-02-15 00:20:35 KST</span>
</div>
