...
- **[USD] Unemployment Claims 발표 주목** — 결과가 다음 거래일 갭 방향을 좌우
  → 발표 직후 미국 선물과 달러 반응을 우선 확인
- **미국장/선물 연동** — 해외장 종가와 선물 괴리가 커지는지 점검
  → 괴리 확대 시 재개장 초반 변동성 확대 가능성
- **원/달러 1,443.3원 체크** — 환율 방향이 외국인 수급에 선행
  → 재개장 시 환율 급변 구간은 추격 매수보다 관망 우선
...
| 항목 | 가격 | 등락 | 등락률 | 흐름 |
|------|------|------|--------|------|
| 비트코인 (BTC) | 69,717 | +752.94 | +1.08% | ↓2일 |
| 이더리움 (ETH) | 2,081.14 | +26.85 | +1.29% | - |
| 공포탐욕지수 | 9 (극단적 공포) | - | - | - |
...
<div class="mp-briefing-meta">
  <span>생성 시각: 2026-02-15 03:17:51 KST</span>
  <span>브리핑 슬롯: pre-market (개장전)</span>
  <span>데이터 기준 시각: 2026-02-15 03:17:51 KST</span>
</div>
