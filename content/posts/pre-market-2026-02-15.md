...
주요 소식으로는 **"트럼프, 새로운 경제 데이터 발표 후 연준에 금리 인하 촉구"** 이 시장의 관심을 끌었습니다.
...
또한 **금리/연준** 관련 소식도 시장에 영향을 주고 있습니다. 연준 비둘기파 신호 → 금리 인하 기대 → 위험자산 선호 → 주식·비트코인 동반 상승

공포지수(VIX)는 20.6로 5일 전(17.36) 대비 +18.66% 급변했습니다.

통계적으로 미국 10년물의 최근 변동은 6개월 기준 **하위 9%** 수준으로, 평소보다 드물게 약한 움직임입니다.

인플레이션 뉴스 → **금융(XLF) 1주 -3.4% 약세**로 직접 연결됩니다.
...
| 쌍 | 20일 상관 | 상태 | 의미 |
|----|----------|------|------|
| S&P 500 ↔ BTC | +0.54 | 🟡 약한 동조 | 약한 위험선호 동조 |
| S&P 500 ↔ 원/달러 | -0.12 | ⚪ 비동조 | 환율 독립적 |
| S&P 500 ↔ 10년물 | +0.12 | ⚪ 비동조 | 독립적 |
| VIX ↔ 금 | +0.03 | ⚪ 비동조 | 독립적 |
| BTC ↔ 금 | +0.02 | ⚪ 비동조 | 독립적 자산 |
