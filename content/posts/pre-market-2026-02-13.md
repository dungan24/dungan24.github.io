...
draft: false
tags: ["pre-market", "브리핑"]
chartData: "/data/chart-data-2026-02-13.json"
---
...
> **S&P -1.57%, 나스닥 -2.04% 약세 마감, 크립토 극단적 공포(9) — AI 랠리**
...
현재 **S&P 500 ↔ BTC**의 20일 상관계수가 +0.62로 동조화 상태입니다. 약한 위험선호 동조

섹터별로는 **반도체**이 1주간 두드러진 강세를 보이고 있습니다.

### 오늘 주목할 것
오늘 가장 주목할 이벤트는 **[USD] Core CPI m/m**입니다. 이전 0.2%, 예상 0.3%.
예상보다 높게 나오면 금리 인하 기대 후퇴 → 주식 하방 압력. 예상보다 낮게 나오면 완화 기대 → 주식 상방.

그 외 **[USD] CPI m/m**, **[USD] CPI y/y** 발표도 체크해두면 좋습니다.
...
### 행동 체크포인트
**관측**: VIX 20.82로 경계 수준 수준
**의미**: 시장 변동성이 점진적으로 상승 중
**시사점**: **[USD] Core CPI m/m** 발표만 체크해도 충분해요

- **[USD] Core CPI m/m 발표 주목** — 지표 결과에 따른 변동성 대비
...
> ↗ 본장 -1.57% 마감 → 선물 +0.43% 반등 중 (Basis: +0.43%)
