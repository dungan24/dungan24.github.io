...
<!-- OPINION_ZONE_START -->## 1. 핵심 요약 (30초)

> **코스피 +2.31%·코스닥 -0.58% 급등, 기관 폭풍 매수**

- 오늘 국내 증시는 강세 흐름으로 장을 마감했어요.
- 수급을 보면, 기관이 약 1조 6천억 원을 쓸어 담은 반면, 외국인은 약 7천억 원을 팔고 빠졌고요.
- 개인 투자자들은 약 1조 원을 던졌습니다.

---
이런 흐름 속에서 오늘의 시장을 좀 더 자세히 들여다볼게요.

## 2. 오늘의 해석

### 시장 마감 흐름
오늘 국내 증시는 앞서 확인한 대로 코스피 +2.31%, 코스닥 -0.58%를 기록하며 꽤 큰 상승 움직임을 보였어요. 수급 측면에서는 기관이 대량 매수하고 외국인과 개인은 매도하는 흐름이 이어졌죠. 미국 시장은 S&P가 -0.28%, 나스닥이 -0.41%의 흐름을 보였습니다. 장 마감 후 눈에 띄었던 뉴스는 "How Jerome Powell Is Trump-Proofing the Fed"이었어요.

### 오늘 장 핵심 움직임
기술, AI, 반도체 이슈가 오늘 장 마감 해석의 핵심 축이었어요. AI 수요 확대에 대한 기대감이 반도체 슈퍼사이클로 이어질 것이라는 전망이 기술주 주도 상승을 이끌었죠. 한편으로는 AI 거품 우려와 밸류에이션 부담이 기술주 차익실현으로 이어지면서 나스닥의 하방 압력으로 작용하기도 했습니다. 오늘 마감 수급은 외국인이 -7,420억 원, 기관이 +16,150억 원으로 확인되었어요. 단기적인 추세는 같은 테마의 해외 시장 반응까지 확인한 뒤 이어가는 것이 더 안전할 거예요.

그렇다면 내일 장에서는 어떤 점을 주목해야 할까요?

### 내일 장 관전 포인트
내일 가장 눈여겨볼 건 바로 [USD] 소비자물가지수(CPI) - January(22:30 KST) 발표입니다. 이 결과에 따라 미국 시장(S&P -0.28%, 나스닥 -0.41%)이 즉각적으로 흔들릴 수 있거든요. 따라서 밤사이 미국 시장의 반응을 먼저 확인하고, 이를 국내 선물 흐름과 연결해서 살펴보시는 게 좋겠습니다.

이러한 관전 포인트를 바탕으로 몇 가지 행동 체크포인트를 정리해봤어요.

### 행동 체크포인트
- **[USD] 소비자물가지수(CPI) - January 대응**
  - 상황: 결과가 시장 예상치와 크게 다르게 나오면 밤사이 미국 선물 시장부터 크게 흔들릴 수 있습니다.
  - 대응: 내일 시초가 갭 방향을 예측하기 위해 선물 시장의 반응을 먼저 확인해 보세요.
  - 해제 기준: 만약 예상 범위 안에서 결과가 나온다면 갭 변동성은 제한적일 거예요.
- **미국장 연결(S&P -0.28%, 나스닥 -0.41%)**
  - 상황: 밤사이 미국 시장이 지금의 방향 그대로 흘러간다면요.
  - 대응: 미국 시장과의 동조화가 이어진다면 내일 아시아 시장도 연속성을 기대할 수 있으니, 비중 유지 또는 확대를 검토해 볼 수 있습니다.
  - 해제 기준: 만약 미국 시장의 흐름이 뒤집히면(부호 반전) 내일 갭 시나리오는 무효가 됩니다.
- **수급 연속성(외국인 약 7천억 매도)**
  - 상황: 오늘 외국인 수급 방향이 내일 시초가까지 계속 이어진다면요.
  - 대응: 수급이 동조화되면 추세가 연장될 수 있으니, 비중 조정을 검토해 보세요.
  - 해제 기준: 만약 내일 수급 방향이 뒤집히면(부호 반전) 기존 추세는 끊긴 것으로 볼 수 있습니다.<!-- OPINION_ZONE_END -->
...
| 시장 | 외국인 | 기관 | 개인 | 프로그램 |
|------|--------|------|------|----------|
| KOSPI | -7,420 | +16,150 | -9,872 | -2,551 |
| KOSDAQ | -2,073 | +231 | +2,318 | — |

#### 업종별 수급 동향 (억 원)

| 업종 | 외국인 | 기관 | 비고 |
|------|--------|------|------|
| 전기전자 | +2,627 | +3,298 | 쌍끌이 매수 |
| 건설업 | -6,591 | +11,282 | 외국인 매도 |
| 운수장비 | -895 | -258 | 쌍끌이 매도 |
| 의약품 | +404 | +348 | 쌍끌이 매수 |
| 전기가스 | +180 | +190 | 쌍끌이 매수 |
| 유통업 | -760 | +532 | 외국인 매도 |
...
<!-- MP_BLOCK_START {"schema_version":"mp-block-v2","block_id":"news.top","priority":60,"as_of_kst":"2026-02-20 21:29:04","max_items":5} -->
### 글로벌
...
<!-- MP_BLOCK_START {"schema_version":"mp-block-v2","block_id":"calendar.recent","priority":55,"as_of_kst":"2026-02-20 21:29:04","max_items":8} -->
<!-- MP_KEY_EVENTS_START -->
<!-- MP_KEY_EVENT_START -->
...
<div class="mp-briefing-meta">
  <span>생성 시각: 2026-02-20 21:29:04 KST</span>
  <span>브리핑 슬롯: post-market (장후)</span>
  <span>데이터 기준 시각: 2026-02-20 21:29:04 KST</span>
</div>
