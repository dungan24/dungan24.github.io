...
| 항목 | 가격 | 등락 | 등락률 | 흐름 |
|------|------|------|--------|------|
| 비트코인 (BTC) | 67,318 | -922.26 | -1.37% | ↓1일 |
| 이더리움 (ETH) | 1,960.1 | -49.39 | -2.52% | - |
| 공포탐욕지수 | 5 (극단적 공포) | - | - | - |
...
| 항목 | 현재가 | 등락 | 등락률 | 흐름 |
|------|--------|------|--------|------|
| 원/달러 (USDKRW) | 1,443.38 | -2.08 | -0.14% | ↓1일 |
...
| 항목 | 현재가 | 등락 | 등락률 |
|------|--------|------|--------|
| S&P 500 선물 | 6,972 | +11.5 | +0.17% |
| 나스닥 100 선물 | 25,291.5 | +3 | +0.01% |

### 원자재

| 항목 | 현재가 | 등락 | 등락률 |
|------|--------|------|--------|
| 국제 금 (Gold) | 5,087.2 | -11.3 | -0.22% |
| WTI 유가 (Oil) | 64.93 | +0.3 | +0.46% |
...
| BTC | 66,714 | 67,318 | +0.91% | 소폭 상승 |
| VIX | 17.69 | 17.65 | -0.23% | 보합 |
| USDKRW | 1,445.5원 | 1,443.38원 | -0.15% | 보합 |
...
**생성 시각**: 2026-02-12 12:30:03 KST
**브리핑 슬롯**: pre-market (개장전)
**데이터 기준 시각**: 2026-02-12 12:30:03 KST
