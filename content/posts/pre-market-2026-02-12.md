...
| 항목 | 가격 | 등락 | 등락률 | 흐름 |
|------|------|------|--------|------|
| 비트코인 (BTC) | 67,380 | -916.37 | -1.36% | ↑1일 |
| 이더리움 (ETH) | 1,963.5 | -46.53 | -2.37% | - |
| 공포탐욕지수 | 5 (극단적 공포) | - | - | - |
...
| 항목 | 현재가 | 등락 | 등락률 | 흐름 |
|------|--------|------|--------|------|
| 원/달러 (USDKRW) | 1,442.58 | -2.88 | -0.20% | ↓2일 |
...
| 나스닥 100 선물 | 25,287.25 | -1.25 | 0.00% |

### 원자재

| 항목 | 현재가 | 등락 | 등락률 |
|------|--------|------|--------|
| 국제 금 (Gold) | 5,085.8 | -12.7 | -0.25% |
...
> 🟢 **Risk-On** — 낙관적 분위기. 낮은 변동성 속 위험자산 선호 심리 지속
...
| 쌍 | 20일 상관 | 상태 | 의미 |
|----|----------|------|------|
| S&P 500 ↔ BTC | +0.77 | 🔴 강한 동조 | 위험자산 동반 움직임 |
| S&P 500 ↔ 원/달러 | +0.51 | 🟡 약한 동조 | 약한 미국 쏠림 |
| S&P 500 ↔ 10년물 | +0.42 | 🟡 약한 동조 | 약한 동반 상승 |
| VIX ↔ 금 | -0.07 | ⚪ 비동조 | 독립적 |
| BTC ↔ 금 | +0.08 | ⚪ 비동조 | 독립적 자산 |
| 유가 ↔ 10년물 | +0.05 | ⚪ 비동조 | 독립적 |
...
**생성 시각**: 2026-02-12 12:36:11 KST
**브리핑 슬롯**: pre-market (개장전)
**데이터 기준 시각**: 2026-02-12 12:36:11 KST
