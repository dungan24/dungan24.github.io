...
### 오늘 주목할 것
오늘 가장 주목할 이벤트는 **[USD] 소비자물가지수(CPI) - January**입니다. 이전 3.1%, 예상 3.0%.
예상보다 높게 나오면 금리 인하 기대 후퇴 → 주식 하방 압력. 예상보다 낮게 나오면 완화 기대 → 주식 상방.
...
**시사점**: **[USD] 소비자물가지수(CPI) - January** 발표만 체크해도 충분해요
...
> 방향성 탐색 중. 지표 확인을 위한 관망세 및 변동성 경계

- **단기 전략**: 관망 우선, 선별적 접근
- **확인 조건**: VIX 안정, 선물 방향 유지
- **무효화 기준**: VIX 급등 또는 주요 경제지표 서프라이즈
