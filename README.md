...
| Fonts | Noto Sans KR (display/sans/mono unified) |
| Charts | ECharts |
| Deploy | GitHub Pages |
...
- 인라인 예외는 `layouts/partials/extend-head-uncached.html`의 데이터 브리지(`window.__MP_CONFIG`, 조건부 `window.__MP_PAGE`)만 허용됩니다.
