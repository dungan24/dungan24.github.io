  ...
  function showError(msg) {
    ...
    if (loadingUI) {
      loadingUI.innerHTML = '<div style="text-align:center;color:#FF3366">'
        + '<div style="font-weight:800;margin-bottom:0.5rem;font-family:Noto Sans KR,sans-serif;letter-spacing:0.05em">[ DATA_UNAVAILABLE ]</div>'
        + '<div style="font-size:12px;opacity:0.9;font-family:JetBrains Mono,monospace;color:#94A3B8">' + msg + '</div></div>';
    }
  }
