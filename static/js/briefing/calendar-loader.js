(function() {
  ...
  ns.transformCalendarSection = function(calendarSection, convertScheduleToCalendar) {
    if (!calendarSection || typeof convertScheduleToCalendar !== 'function') return;
    if (calendarSection.dataset && calendarSection.dataset.mpCalendarEnhanced === 'true') return;
    if (calendarSection.dataset) calendarSection.dataset.mpCalendarEnhanced = 'true';
